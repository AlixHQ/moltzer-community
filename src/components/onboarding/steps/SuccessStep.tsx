  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl w-full text-center space-y-8 relative z-10">
        ...
        >
          {[
            { icon: "⚡", title: "Lightning Fast", desc: "Your data stays local. No cloud delays.", gradient: "from-orange-500/10 to-red-500/10", border: "border-orange-500/20" },
            { icon: "🔐", title: "Totally Private", desc: "Everything runs on your machine.", gradient: "from-purple-500/10 to-pink-500/10", border: "border-purple-500/20" }
          ].map((benefit, index) => (
            <motion.div
              key={benefit.title}
              role="listitem"
            ...
            >
              <div className="text-2xl mb-2" role="img" aria-label={benefit.title}>
                {benefit.icon}
              </div>
