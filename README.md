...
[![CI](https://github.com/TripModeHQ/moltzer-community/actions/workflows/ci.yml/badge.svg)](https://github.com/TripModeHQ/moltzer-community/actions/workflows/ci.yml)
[![Release](https://github.com/TripModeHQ/moltzer-community/actions/workflows/release.yml/badge.svg)](https://github.com/TripModeHQ/moltzer-community/actions/workflows/release.yml)
[![License: Apache 2.0](https://img.shields.io/badge/License-Apache_2.0-yellow.svg)](https://opensource.org/licenses/MIT)
[![Platform](https://img.shields.io/badge/platform-macOS%20%7C%20Windows%20%7C%20Linux-blue)](https://github.com/TripModeHQ/moltzer-community/releases)
[![Tauri](https://img.shields.io/badge/tauri-v2-orange)](https://tauri.app/)
[![Version](https://img.shields.io/badge/version-1.0.0-green)](https://github.com/TripModeHQ/moltzer-community/releases/latest)
...
[Download](https://github.com/TripModeHQ/moltzer-community/releases) • [Quick Start](#-quick-start) • [Features](#-features) • [Documentation](./SETUP.md) • [Contributing](./CONTRIBUTING.md)
...
1. **[Download Moltzer](https://github.com/TripModeHQ/moltzer-community/releases)** for your platform
...
# https://github.com/TripModeHQ/moltzer-community/releases
...
```bash
# Clone the repo
git clone https://github.com/TripModeHQ/moltzer-community.git
cd molt-client
...
See [GitHub Issues](https://github.com/TripModeHQ/moltzer-community/issues) for full list and workarounds.
...
3. **Update to latest version:**
   - Check [Releases](https://github.com/TripModeHQ/moltzer-community/releases)
...
2. **Report a bug:**
   - [Open an issue](https://github.com/TripModeHQ/moltzer-community/issues/new/choose)
   - Include: OS version, Moltzer version, error messages, logs

3. **Get help:**
   - [GitHub Discussions](https://github.com/TripModeHQ/moltzer-community/discussions)
...
- **Issues:** [GitHub Issues](https://github.com/TripModeHQ/moltzer-community/issues)
- **Discussions:** [GitHub Discussions](https://github.com/TripModeHQ/moltzer-community/discussions)
- **Email:** support@moltzer.dev
...
<div align="center">
  ...
  <p>
    <a href="https://github.com/TripModeHQ/moltzer-community">GitHub</a> •
